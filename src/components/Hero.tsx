  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-center">
        <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-brand-400/30 bg-brand-500/12 px-4 py-2 text-sm font-medium text-brand-100">
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-7xl font-extrabold text-white leading-tight mb-6">
          ...
          <span className="bg-gradient-to-r from-brand-100 via-brand-300 to-brand-500 bg-clip-text text-transparent">
            através da tecnologia
          </span>
        </h1>

        <p className="text-brand-100/72 text-lg sm:text-xl max-w-2xl mx-auto mb-12">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="#servicos"
            className="rounded-full bg-brand-500 px-8 py-4 text-lg font-semibold text-white transition-all hover:bg-brand-400 brand-glow"
          >
            Nossos Serviços
          </Link>
          <Link
            href="#contato"
            className="rounded-full border border-brand-700 px-8 py-4 text-lg font-semibold text-brand-100 transition-all hover:border-brand-400 hover:bg-brand-900/60 hover:text-white"
          >
            Fale Conosco
          </Link>
        </div>
